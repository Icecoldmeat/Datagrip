...
exec sp_addextendedproperty 'MS_Description',
     ...
     'SCHEMA', 'dbo', 'FUNCTION', 'ufnGetContactInformation'
go
...
exec sp_addextendedproperty 'MS_Description',
     ...
     'SCHEMA', 'dbo', 'FUNCTION', 'ufnGetContactInformation', 'COLUMN', 'PersonID'
go

exec sp_addextendedproperty 'MS_Description',
     'Input parameter for the table value function ufnGetContactInformation. Enter a valid PersonID from the Person.Contact table.',
     'SCHEMA', 'dbo', 'FUNCTION', 'ufnGetContactInformation', 'PARAMETER', '@PersonID'
go
