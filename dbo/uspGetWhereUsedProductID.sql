...
exec sp_addextendedproperty 'MS_Description',
     ...
     'SCHEMA', 'dbo', 'PROCEDURE', 'uspGetWhereUsedProductID'
go
...
exec sp_addextendedproperty 'MS_Description',
     ...
     'SCHEMA', 'dbo', 'PROCEDURE', 'uspGetWhereUsedProductID', 'PARAMETER', '@StartProductID'
go
...
exec sp_addextendedproperty 'MS_Description',
     ...
     'SCHEMA', 'dbo', 'PROCEDURE', 'uspGetWhereUsedProductID', 'PARAMETER', '@CheckDate'
go
